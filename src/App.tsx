  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
            ...
            <div className="hidden md:flex items-center gap-8">
              <button 
                ...
                className={cn(
                  ...
                  activeTab === 'chat' ? "text-emerald-600" : "text-slate-500 hover:text-emerald-500"
                )}
              >
                智能导诊
              </button>
              <button 
                ...
                className={cn(
                  "text-sm font-medium transition-colors",
                  activeTab === 'hospitals' ? "text-emerald-600" : "text-slate-500 hover:text-emerald-500"
                )}
              >
                附近医院
              </button>
              <div className="h-6 w-px bg-slate-200" />
              <button className="px-4 py-2 bg-emerald-600 text-white rounded-xl text-sm font-medium hover:bg-emerald-700 transition-all shadow-md shadow-emerald-100">
                立即咨询
              </button>
            </div>
          ...
          >
            <div className="px-4 py-4 space-y-4">
              <button 
                ...
                className="block w-full text-left px-4 py-2 text-slate-600 hover:bg-emerald-50 rounded-lg"
              >
                智能导诊
              </button>
              <button 
      ...
      <header className="relative bg-white overflow-hidden pt-12 pb-24">
        ...
        <div className="absolute bottom-0 left-0 translate-y-1/2 -translate-x-1/4 w-[400px] h-[400px] bg-teal-50 rounded-full blur-3xl opacity-50" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center max-w-3xl mx-auto">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3 py-1 bg-emerald-50 text-emerald-600 rounded-full text-xs font-bold mb-6 border border-emerald-100"
            >
            ...
            <motion.h1 
              ...
              className="text-4xl md:text-6xl font-display font-extrabold tracking-tight text-slate-900 mb-6"
            >
              您的全天候 <span className="text-emerald-600">智能医疗</span> 导诊专家
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-display font-bold text-slate-900 mb-3">专业症状分析</h3>
            ...
            <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-display font-bold text-slate-900 mb-3">精准科室���荐</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
            ...
            <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-display font-bold text-slate-900 mb-3">优质资源导航</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-display font-bold text-slate-900">MediGuide AI</span>
            </div>
